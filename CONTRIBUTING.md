# Contributing to im-e-metering

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
im-e-metering. These guidelines are not strict rules.
...
The im-e-metering team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the im-e-metering technical leads
...
[issues]: https://github.com/Netbeheer-Nederland/im-e-metering/issues/
[pulls]: https://github.com/Netbeheer-Nederland/im-e-metering/pulls/
